...
#define KL0_PG_USB0_PMI_ENABLE		0x00000400	/* (Pangea Only) */
#define KL0_IRDA_RESET			0x00000800	/* (KL Only) */
#define KL0_PG_USB0_REF_SUSPEND_SEL	0x00000800	/* (Pangea Only) */
#define KL0_IRDA_DEFAULT1		0x00001000	/* (KL Only) */
#define KL0_PG_USB0_REF_SUSPEND		0x00001000	/* (Pangea Only) */
#define KL0_IRDA_DEFAULT0		0x00002000	/* (KL Only) */
#define KL0_PG_USB0_PAD_SUSPEND		0x00002000	/* (Pangea Only) */
#define KL0_IRDA_FAST_CONNECT		0x00004000	/* (KL Only) */
#define KL0_PG_USB1_PMI_ENABLE		0x00004000	/* (Pangea Only) */
#define KL0_IRDA_ENABLE			0x00008000	/* (KL Only) */
#define KL0_PG_USB1_REF_SUSPEND_SEL	0x00008000	/* (Pangea Only) */
#define KL0_IRDA_CLK32_ENABLE		0x00010000	/* (KL Only) */
#define KL0_PG_USB1_REF_SUSPEND		0x00010000	/* (Pangea Only) */
#define KL0_IRDA_CLK19_ENABLE		0x00020000	/* (KL Only) */
#define KL0_PG_USB1_PAD_SUSPEND		0x00020000	/* (Pangea Only) */
...
#define KL1_EIDE0_ENABLE		0x00800000	/* KL Only */
#define KL1_EIDE0_RESET_N		0x01000000	/* KL Only */
...
#define KL2_CARDSLOT_RESET		0x00040000	/* Pangea Only */
...
#define KL5_PWM_CLK32_EN		0x000000004	/* Pangea Only */
#define KL5_CLK3_68_EN			0x000000010	/* Pangea Only */
#define KL5_CLK32_EN			0x000000020	/* Pangea Only */
